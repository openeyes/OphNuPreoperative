...
/**
 * This is the model class for table "et_ophnupreoperative_skinassessment".
 *
...
class Element_OphNuPreoperative_SkinAssessment  extends  BaseEventTypeElement
{
	/**
	...
	{
		return 'et_ophnupreoperative_skinassessment';
	}
	...
	{
		return array(
			array('event_id, bruising, warm, cool, dry, moist, other, other_comments, ', 'safe'),
			array('bruising, warm, cool, dry, moist, other, other_comments, ', 'required'),
			array('id, event_id, bruising, warm, cool, dry, moist, other, other_comments, ', 'safe', 'on' => 'search'),
		);
	}
