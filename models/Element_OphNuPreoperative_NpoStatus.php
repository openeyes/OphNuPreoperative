...
/**
 * This is the model class for table "et_ophnupreoperative_npostatus".
 *
...
class Element_OphNuPreoperative_NpoStatus  extends  BaseEventTypeElement
{
	...
	{
		return 'et_ophnupreoperative_npostatus';
	}
	...
	public function rules()
	{
		...
		return array(
			array('event_id, time_last_ate, time_last_drank, ', 'safe'),
			array('time_last_ate, time_last_drank, ', 'required'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, event_id, time_last_ate, time_last_drank, ', 'safe', 'on' => 'search'),
		);
	}
