...
/**
 * This is the model class for table "et_ophnupreoperative_translator".
 *
 ...
 * @property OphNuPreoperative_Translator_TranslatorPresent $translator_present
 */

class Element_OphNuPreoperative_Translator  extends  BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophnupreoperative_translator';
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'translator_present' => array(self::BELONGS_TO, 'OphNuPreoperative_Translator_TranslatorPresent', 'translator_present_id'),
		);
	}
