...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('is_pain'))?>:</td>
			<td><span class="big"><?php echo $element->is_pain ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
		...
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('pain_score_method'))?></td>
			<td><span class="big"><?php echo CHtml::encode($element->pain_score_method)?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('back'))?></td>
			<td><span class="big"><?php echo $element->back ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('neck'))?></td>
			<td><span class="big"><?php echo $element->neck ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('arm'))?></td>
			<td><span class="big"><?php echo $element->arm ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('leg'))?></td>
			<td><span class="big"><?php echo $element->leg ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('head'))?></td>
			<td><span class="big"><?php echo $element->head ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
