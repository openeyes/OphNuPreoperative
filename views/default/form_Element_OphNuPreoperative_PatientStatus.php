...
?>
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'cancels', 'cancels', 'cancel_id', CHtml::listData(OphNuPreoperative_PatientStatus_Cancel::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Reason for cancelation','class' => 'linked-fields', 'data-linked-fields' => 'res_comments', 'data-linked-values' => 'Other'), !($element->patient_status_id==2), false, null, false, false, array('label' => 3, 'field' => 4))?>
