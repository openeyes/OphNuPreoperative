...
<section class="element <?php echo $element->elementType->class_name?>"
	...
	<div class="element-fields">
		<?php echo $form->radioButtons($element, 'patient_status_id', CHtml::listData(OphNuPreoperative_PatientStatus_PatientStatus::model()->findAll(array('order'=> 'display_order asc')),'id','name'),null,false,false,false,false,array(),array('label' => 3, 'field' => 9))?>
