...
?>
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'wristbands', 'wristbands', 'ophnupreoperative_preoperative_wristband_id', CHtml::listData(OphNuPreoperative_PreoperativeAssessment_Wristband::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Special attention wristband attached?'), false, false, null, false, false, array('label' => 3, 'field' => 4), false, 'N/A')?>
		...
		<?php echo $form->multiSelectList($element, 'falls', 'falls', 'ophnupreoperative_preoperative_falls_id', CHtml::listData(OphNuPreoperative_PreoperativeAssessment_Falls::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Falls / mobility items'), !$element->falls_mobility, false,null,false,false,array('label' => 3, 'field' => 4))?>
		...
		<?php echo $form->multiSelectList($element, 'dentals', 'dentals', 'ophnupreoperative_preoperative_dental_id', CHtml::listData(OphNuPreoperative_PreoperativeAssessment_Dental::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Items', 'class' => 'linked-fields', 'data-linked-fields' => 'd_comments', 'data-linked-values' => 'Other (please specify)'),!$element->removable_dental_work_present, false,null,false,false,array('label' => 3, 'field' => 4))?>
