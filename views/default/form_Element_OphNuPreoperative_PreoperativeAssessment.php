...
?>
	<div class="element-fields">
		...
		<?php echo $form->radioBoolean($element, 'patient_belongings', array('class' => 'linked-fields', 'data-linked-fields' => 'belongings,patient_belongings_comments', 'data-linked-values' => 'Yes'), array('label' => 3, 'field' => 4))?>
		...
		<?php echo $form->textArea($element, 'patient_belongings_comments', array(), !$element->patient_belongings, array(), array('label' => 3, 'field' => 4))?>
	</div>
