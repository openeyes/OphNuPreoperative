...
?>
	<div class="element-fields">
		...
		<?php echo $form->multiSelectList($element, 'MultiSelect_dental', 'dentals', 'ophnupreoperative_preoperative_dental_id', CHtml::listData(OphNuPreoperative_PreoperativeAssessment_Dental::model()->findAll(array('order'=>'display_order asc')),'id','name'), array(), array('empty' => '- Please select -', 'label' => 'Items', 'class' => 'linked-fields', 'data-linked-fields' => 'd_comments', 'data-linked-values' => 'Other (please specify)'),!$element->removable_dental_work_present, false,null,false,false,array('label' => 3, 'field' => 4))?>
