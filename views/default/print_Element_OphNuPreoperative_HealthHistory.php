...
<table class="subtleWhite normalText">
	<tbody>
		<tr>
			<td width="30%"><?php echo CHtml::encode($element->getAttributeLabel('health_history_verfied'))?>:</td>
			<td><span class="big"><?php echo $element->health_history_verfied ? 'Yes' : 'No'?></span></td>
		</tr>
		<tr>
