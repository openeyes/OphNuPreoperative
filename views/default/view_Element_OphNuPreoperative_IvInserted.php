...
<section class="element">
	<header class="element-header">
		...
		<div class="element-data">
			...
			<div class="large-2 column"><div class="data-label"><?php echo CHtml::encode($element->getAttributeLabel('location'))?></div></div>
			<div class="large-10 column end"><div class="data-value"><?php echo CHtml::encode($element->location)?></div></div>
		</div>
		<div class="row data-row">
